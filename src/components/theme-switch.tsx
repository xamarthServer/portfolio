...
export default function ThemeSwitch() {
    ...
    return (
        <button
            onClick={toggleTheme}
            className="fixed z-[99999] right-5 top-10 w-[3rem] h-[1rem] bg-opacity-0 backdrop-blur-[0rem] rounded-full flex items-center justify-center hover:scale-[1.5] active:scale-0 transition-transform active:rotate-90 cursor-pointer">
            {
                theme === "dark" ? (moon) : (sun)
            }
        </button>
