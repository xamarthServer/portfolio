...
export default function Intro() {
    ...
    return (
        <section
            ...
            <motion.h1 className="mb-10 mt-4 px-4 text-2xl font-medium tracking-wide !leading-[1.5] sm:text-4xl"
            ...
            <motion.div className="flex flex-col sm:flex-row items-center justify-center gap-2 px-4 text-lg font-medium"
                ...
                <a
                    ...
                    target="_blank"
                    className="ldL flex bg-white text-gray-700 p-4 items-center gap-2 text-[1.5rem] rounded-full outline-none hover:text-gray-950 hover:scale-120 active:scale-105 transition cursor-pointer shadow-lg">{linkedin}
                    {/* <BsLinkedin /> */}
                </a>
                <a
                    href="https://github.com/xamarth"
                    target="_blank"
                    className="ghL flex bg-white text-gray-700 p-4 items-center gap-2 text-[1.5rem] rounded-full outline-none hover:text-gray-950 hover:scale-120 active:scale-105 transition cursor-pointer shadow-lg">{github}
                    {/* <FaSquareGithub /> */}
                </a>
            </motion.div>
